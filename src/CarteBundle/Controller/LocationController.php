...
class LocationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $locations = $em->getRepository('CarteBundle:Location')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('CarteBundle\Form\LocationType', $location);
    ...
    {
        $deleteForm = $this->createDeleteForm($location);
        $editForm = $this->createForm('CarteBundle\Form\LocationType', $location);
